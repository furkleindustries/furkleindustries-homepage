...
$(document).ready(function() {
	...
	function addStartingTwElements() {
		...
		getTwineElement('tw-passage').append("<mark style='display: inline-block;'><span style='display: block;'>I am a mark.</span><img width='50%' height='auto' src='https://furkleindustries.com/images/furkle.png'</img></mark><mark style='display: none'>");
